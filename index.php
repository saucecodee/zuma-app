...
<body>
     ...
     <header>
          <div class="container">
               ...
               <svg class="mob-logo" width="97" height="30" viewBox="0 0 97 30" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <path d="M24.034 22.1591V17.5852H17.0841L23.8014 11.5625V7.84091H9.6979V12.4148H16.3861L9 18.8068V22.1591H24.034Z"
                         fill="#2541B2" />
                    <path d="M26.7327 16.2216C26.7327 18.267 27.4597 19.8295 28.9137 20.9091C30.3676 21.9602 32.1415 22.5 34.2643 22.5C36.387 22.5 38.1609 21.9602 39.6149 20.9091C41.0688 19.858 41.7958 18.2955 41.7958 16.2216V7.84091H36.358V15.7386C36.358 17.017 35.6601 17.6705 34.2643 17.6705C32.8684 17.6705 32.1705 17.017 32.1705 15.7386V7.84091H26.7327V16.2216Z"
                         fill="#2541B2" />
                    <path d="M50.5941 22.1591V14.4034C50.5941 13.0398 51.4083 12.1023 52.4552 12.1023C53.502 12.1023 54.1418 12.9545 54.1418 14.3182V22.1591H59.5215V14.4034C59.5215 13.0398 60.3066 12.1023 61.3825 12.1023C62.4294 12.1023 63.0401 12.9545 63.0401 14.3182V22.1591H68.4197V13.6932C68.4197 9.74432 66.5877 7.5 63.1855 7.5C60.9464 7.5 59.2888 8.23864 58.2711 9.71591C57.5732 8.23864 56.2355 7.5 54.2581 7.5C52.6006 7.5 51.3793 8.21023 50.5941 9.60227V7.84091H45.2144V22.1591H50.5941Z"
                         fill="#2541B2" />
                    <path d="M71.2039 15C71.2039 17.0455 71.9018 18.7784 73.2685 20.1989C74.6352 21.6193 76.38 22.3295 78.4446 22.3295C80.5674 22.3295 81.9051 21.7614 82.4866 20.6534V22.1591H87.75V7.84091H82.4866V9.34659C81.9051 8.23864 80.5674 7.67045 78.4446 7.67045C76.38 7.67045 74.6352 8.38068 73.2685 9.82955C71.9018 11.25 71.2039 12.983 71.2039 15ZM76.5254 15C76.5254 13.5227 77.9212 12.2727 79.5787 12.2727C81.2362 12.2727 82.632 13.5227 82.632 15C82.632 16.5057 81.2362 17.7273 79.5787 17.7273C77.9212 17.7273 76.5254 16.5057 76.5254 15Z"
                         fill="#2541B2" />
               </svg>
     ...
     <div class="gallery">
          <div class="container">
               <h1 class="s-title">View app <br> screenshots</h1>

               <div class="screens">
                    <img class="s1" src="./assets/screens/screen-1.png" alt="">
                    <img class="s2" src="./assets/screens/screen-2.png" alt="">
                    <img class="s3" src="./assets/screens/screen-3.png" alt="">
                    <img class="s4" src="./assets/screens/screen-4.png" alt="">
                    <img class="s5" src="./assets/screens/screen-5.png" alt="">
                    <img class="s6" src="./assets/screens/screen-6.png" alt="">
               </div>
     ...
     <div class="s-m-up">
          <div class="container">
               <div>
                    ...
                    <form action="form.php" method="post">
                         <input type="email" name="email" placeholder="Enter your e-mail address" required autofocus>
     ...
     <footer>
          <div class="container">
               ...
               <div>Developed with 🍅 by Saucecode</div>
          </div>
     </footer>
